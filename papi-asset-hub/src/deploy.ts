...
export async function deployLocal(api: TypedApi<typeof local>, signer: PolkadotSigner, name: string) {
...
export async function deployAh(api: TypedApi<typeof hub>, signer: PolkadotSigner, name: string) {    
