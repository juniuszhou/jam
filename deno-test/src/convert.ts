...
export function ethAddressToReviveSS58(address: string): string {
  // 24 es
  const postfix = "eeeeeeeeeeeeeeeeeeeeeeee";
  const pubkey: string = address + postfix;
  return convertPublicKeyToSs58(hexToU8a(pubkey));
}
